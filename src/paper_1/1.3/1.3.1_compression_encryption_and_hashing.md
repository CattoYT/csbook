...
Symmetrical key encryption is where both parties share an identical key. 
When both users have the key, both users are able to encrypt and decrypt data using that same key. 
